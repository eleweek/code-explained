...
export function SimplifiedCreateTheory() {
    return (
        <>
            ...
            <ProbingVisualization slotsCount={8} links={probingLinks} adjustTop={-70} fixedHeight={100} />
            Если текущая ячейка занята, то мы проверим следующую. Если занята и она, то проверим следующую за ней. И так
            до тех пор, пока не найдем свободную ячейку.
            ...
            <p>
                ...
                стараются достичь баланса. Таблица должна быть не слишком пустой, но и не слишком заполненной. Заметные
                проблемы с производительностью начинаются при заполненности на две трети.
            </p>
