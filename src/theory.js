...
export function BubbleSortTheory() {
    return (
        <>
            ...
            <p>
                Пузырьковая сортировка — самая простая для понимания и реализации сортировка. Алгоритм по очереди
                просматривает все элементы списка — сравнивает текущий элемент со следующим и при необходимости меняет
                их местами. Таким образом, алгоритм проходит по списку, пока все элементы не будут упорядочены.
            </p>
    ...
    return (
        <>
            ...
            <p>
                ...
                — все большие. Таким образом массив становится несколько более упорядоченным и делитель оказывается на
                нужном месте.
            </p>
